...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.gridLayout_3.addItem(self.horizontalSpacer_4, 4, 0, 1, 5)
        ...
        self.GIFdeCarga = QLabel(self.layoutWidget)
        self.GIFdeCarga.setObjectName(u"GIFdeCarga")
        self.GIFdeCarga.setScaledContents(True)

        self.gridLayout_3.addWidget(self.GIFdeCarga, 3, 2, 1, 1)
