...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.widget.setGeometry(QRect(0, -10, 1361, 571))
        ...
        self.label.setPixmap(QPixmap(u"../Downloads/Prueba Login QT/User.png"))
        ...
        self.label_2.setPixmap(QPixmap(u"../Downloads/Prueba Login QT/User.png"))
        ...
        self.label_3.setPixmap(QPixmap(u"../Downloads/Prueba Login QT/Contrase\u00f1a.png"))
